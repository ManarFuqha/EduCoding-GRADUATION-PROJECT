...
namespace courseProject.Repository.Migrations
{
    ...
    [Migration("20240625184453_addTables")]
            ...
            modelBuilder.Entity("courseProject.Core.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("f9587613-8def-42c3-93a9-65a644842a58"),
                            IsVerified = true,
                            dateOfAdded = new DateTime(2024, 6, 25, 21, 44, 52, 885, DateTimeKind.Local).AddTicks(3227),
